import { AuthProvider, TAuthProviderCreatorProps } from 'react-admin';
import type { AxiosError } from 'axios';
import { fetchClient } from './fetchClient';
import { tokenManager, TokenData } from './tokenManager';

type AuthProviderCreatorProps = Omit<TAuthProviderCreatorProps, 'fetchClient'>;
type AuthProviderCreator = (props?: AuthProviderCreatorProps) => AuthProvider;
